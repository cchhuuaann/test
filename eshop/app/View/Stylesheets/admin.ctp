...
foreach ($stylesheets AS $stylesheet)
{
	echo $this->Admin->TableCells(
		  array(
			...
			array($this->Ajax->link(($stylesheet['Stylesheet']['active'] == 1?$this->Html->image('admin/icons/true.png', array('alt' => __('True'))):$this->Html->image('admin/icons/false.png', array('alt' => __('False')))), 'null', $options = array('escape' => false, 'url' => '/stylesheets/admin_change_active_status/' . $stylesheet['Stylesheet']['id'], 'update' => 'content'), null, false), array('align'=>'center')),
