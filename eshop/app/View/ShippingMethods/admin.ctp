...
foreach ($modules AS $module)
{
	...
	{
		$action_button = $this->Admin->linkButton(__('Install'),'/shipping/' . $module['code'] . '/install/','install.png',array('escape' => false, 'class' => 'button'));
	}
	else
	{
		$action_button = $this->Admin->linkButton(__('Uninstall'),'/shipping/' . $module['code'] . '/uninstall/','uninstall.png',array('escape' => false, 'class' => 'button'),__('Are you sure?'));
	}
...
echo $this->Admin->linkButton(__('Add module'), '/shipping_methods/admin_add/', 'add.png', array('escape' => false, 'class' => 'button'));
