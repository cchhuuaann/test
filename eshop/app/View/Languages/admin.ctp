...
foreach ($language_data AS $language)
{
	echo $this->Admin->TableCells(
		  array(
				...
				array($this->Ajax->link(($language['Language']['active'] == 1?$this->Html->image('admin/icons/true.png', array('alt' => __('True'))):$this->Html->image('admin/icons/false.png', array('alt' => __('False')))), 'null', $options = array('escape' => false, 'url' => '/languages/admin_change_active_status/' . $language['Language']['id'], 'update' => 'content'), null, false), array('align'=>'center')),
