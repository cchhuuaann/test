...
(156, 2, 'Firstname', 'Имя', '2009-09-12 20:08:49', '2009-09-12 20:08:49'),
(157, 1, 'Lastname', 'Lastname', '2009-09-12 20:08:49', '2009-09-12 20:08:49'),
(158, 2, 'Lastname', 'Фамилия', '2009-09-12 20:08:49', '2009-09-12 20:08:49'),
...
(8, 1, 7, 0, 'Downloadable Product Info', '<script type="text/javascript" src="{base_path}/js/jquery/jquery.min.js"></script>\n<link rel="stylesheet" type="text/css" href="{base_path}/css/jquery.fancybox-1.2.5.css" media="screen" />\n<script type="text/javascript" src="{base_path}/js/jquery/plugins/fancybox/jquery.fancybox-1.2.5.pack.js"></script>\n\n<script type="text/javascript">\n  $(document).ready(function() {\n    $("a.zoom").fancybox({\n    "zoomOpacity"      : true,\n    "overlayShow"      : false,\n    "zoomSpeedIn"      : 250,\n    "zoomSpeedOut"      : 250\n  });\n  });\n\n  function onProductFormSubmit() {\n    var str = $("#product-form").serialize();\n\n    $.post("/cart/purchase_product", str, function(data) {\n      $("#shopping-cart-box").html(data);\n    });\n\n  }\n</script>\n\n\n<div id="product_details_left">\n  {description}\n</div>\n<div id="product_details_right">\n  <div class="product_images">{content_images}</div>\n  <div class="pricing">\n{downloadable_prices}\n    <div style="clear: both"></div>\n    <div style="clear: both"></div>\n    {if ''1'' == $ajax_enable}\n        {product_form_ajax}\n        <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\n        {/product_form_ajax}\n    {else}\n        {product_form}\n        <div class="product_price">{product_quantity} {purchase_button id=$content_id}</div>\n        {/product_form}\n    {/if}\n    {module alias=''reviews'' action=''link''}\n  </div>\n</div>\n<div style="clear:both;"></div>', '2012-11-04 00:00:00', '2012-11-04 22:29:23');
